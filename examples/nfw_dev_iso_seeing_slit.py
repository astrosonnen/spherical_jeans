...
# this code calculates the seeing-convolved, surface brightness weightedd line-of-sight stellar velocity dispersion of a galaxy with a Navarro, Frenk & White (NFW) density profile, tracers decsribed by a spherically deprojected de Vaucouleurs profile and isotropic orbits, within a rectangular aperture of width 0.5Reff and height 1.0Reff.

Reff = 5. # half-light radius in kpc
aperture = [0.5*Reff, 1.*Reff] # size (width x height) of rectangular aperture within which the velocity dispersion is calculated
